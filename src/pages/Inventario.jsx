      ...
      <main className="flex-1 px-6 pb-24 space-y-6 overflow-y-auto relative z-0">
        ...
        {vista === 'listaProductos' && cantinaSeleccionada && (
          <div className="space-y-4 animate-in slide-in-from-right-4">
            ...
            <button onClick={() => setShowModal(true)} className="fixed bottom-20 right-8 w-16 h-16 bg-brand-primary text-white rounded-full shadow-lg flex items-center justify-center hover:bg-brand-secondary active:scale-90 transition-all z-20">
