      ...
      <main className="flex-1 px-6 pb-24 space-y-6">
        ...
        {vista === 'lista' && (
          ...
          <div className="space-y-4">
            ...
            <button onClick={() => { setVista('crear'); setError(null); setExito(null); }} className="fixed bottom-8 right-8 w-16 h-16 bg-brand-primary text-white rounded-full shadow-lg flex items-center justify-center hover:bg-brand-secondary active:scale-90 transition-all z-20">
